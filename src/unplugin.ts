...
const resolvePluginOptions = (
  options: HonoEmailTailwindPluginOptions = {},
  ...
  runtimeModuleSpecifier:
    options.runtimeModuleSpecifier?.trim() || options.packageNames?.[0] || DEFAULT_PACKAGE_NAMES[0],
...
const EmailTailwind: UnpluginInstance<HonoEmailTailwindPluginOptions | undefined, boolean> =
  createUnplugin(factory);

export default EmailTailwind;
export const rollupPlugin: UnpluginInstance<
  HonoEmailTailwindPluginOptions | undefined,
  boolean
>["rollup"] = EmailTailwind.rollup;
export const vitePlugin: UnpluginInstance<
  HonoEmailTailwindPluginOptions | undefined,
  boolean
>["vite"] = EmailTailwind.vite;
...
export const farmPlugin: UnpluginInstance<
  HonoEmailTailwindPluginOptions | undefined,
  boolean
>["farm"] = EmailTailwind.farm;
export const bunPlugin: UnpluginInstance<
  HonoEmailTailwindPluginOptions | undefined,
  boolean
>["bun"] = EmailTailwind.bun;
