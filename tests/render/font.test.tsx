...
describe('Font', () => {
  ...
  test('renders @font-face when webFont is provided', async () => {
    ...
    expect(html).toContain("src: url(https://fonts.gstatic.com/s/roboto/v27/roboto.woff2) format('woff2');")
  ...
  test('is rejected outside head in strict mode', async () => {
    await expect(
      ...
      'The <style> tag must be placed inside <Head> in HTML email strict mode.'
    )
  })
})
